...
public class EstudianteService extends AAlBaseService {
    ...
    public List<Estudiante> getAll(){
        EntityManager em = getEm();
        List<Estudiante> estudianteList = em.createNamedQuery("Estudiante.getAll").getResultList();
        return estudianteList;
    }
    
    public Estudiante getById(Integer id){
        EntityManager em = getEm();
        Estudiante estudiante = (Estudiante) em.createNamedQuery("Estudiante.getById").setParameter("EstudianteId", id).getSingleResult();
        return estudiante;
    }
    ...
    public List<Estudiante> getByQuery(String statement){
        EntityManager em = getEm();
        List<Estudiante> estudianteList = em.createQuery(statement).getResultList();
        return estudianteList;
    }
    ...
    public void updateName(Integer id, String nombre){
        ...
        EntityTransaction tx = em.getTransaction();
        tx.begin();
        Query query = em.createNamedQuery("Estudiante.setNombre").setParameter("EstudianteId", id).setParameter("EstudianteNombre", nombre);
        query.executeUpdate();
        tx.commit();
    }
    ...
    public List<Estudiante> getByFK(Integer fk){
        EntityManager em = getEm();
        List<Estudiante> estudianteList = em.createQuery("FROM Estudiante WHERE ids = " + fk.toString()).getResultList();
        return estudianteList;
    }
