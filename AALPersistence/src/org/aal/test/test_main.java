...
public class test_main {
    ...
    private static final Logger _log = Logger.getLogger(test_main.class);
    ...
    EntityManagerFactory emf= javax.persistence.Persistence.createEntityManagerFactory("AALPersistencePU");
